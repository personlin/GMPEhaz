...
#'
#' \code{BSSA14} returns the ground-motion prediction with it sigma of Boore et al.(2014) GMPE.
#'
...
#'
#' @export
BSSA14 <- function(Mag, Rjb, Prd, Vs30, ftype=0, Z1.0, regionflag=0, basinflag=0){
  #     Notes:
  #            Region Flag:
  #               0 = Global
  #               1 = China-Turkey
