...
#'
#' \code{I14} returns the ground-motion prediction with it sigma of Akkar et al.(2014) GMPE.
#'
...
#'
#' @export
I14 <- function(Mag, Rrup, Prd=0, ftype=0, Vs30=760){
  ...
  retvals <- .Fortran("I_NGAWest2_2013", m=as.single(Mag), Rrup=as.single(Rrup), ftype=as.single(ftype),
