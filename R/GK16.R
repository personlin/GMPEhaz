...
#' @param Z15 Depth to the 1.5km/s shear-wave velocity isosurfac.
#'
...
#'
#' @export
GK16 <- function(Mag, Rrup, ftype=0, Prd, Vs30=760, q0=150, Z15){
  ...
  retvals <- .Fortran("GK_Nov2012", mag=as.single(Mag), Rrup=as.single(Rrup), ftype=as.single(ftype),
                      ...
                      iflag=as.integer(0), vs=as.single(Vs30), q0=as.single(q0), depthvs15=as.single(Z15))
