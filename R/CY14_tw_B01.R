...
#'
#' \code{CY14.tw.B01} returns the ground-motion prediction with it sigma of Chiou and Youngs(2014) GMPE
#' adjusted to Taiwan.
#'
...
CY14.tw.B01 <- function(Mag, Rrup, Rjb, Prd, Vs30, Dip, Ztor, ftype=0, Z1.0, Vs30_class=1, hwflag=0, Rx,
  ...
  retvals <- .Fortran("CY14_TW_B01", mag=as.single(Mag), Rrup=as.single(Rrup), Rbjf=as.single(Rjb),
