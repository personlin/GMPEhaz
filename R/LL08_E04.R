...
#'
#' \code{LL08.E04} returns the ground-motion prediction with it sigma of adjusted Lin and Lee(2008) GMPE.
#'
...
#'
#' @examples
#' LL08.E04(6, 20, 10, 0, 0, 760)
#' LL08.E04(7, 10, 10, 0, 0, 760)
#'
#' @export
LL08.E04 <- function(Mag, Rrup, Ztor, ftype=0, Prd, Vs30=760) {
  # subroutine S04_LL08_E04 ( mag, rupdist, specT, period, lnY, sigma,
  #                           iflag, Ztor, ftype, vs30)
  if (Prd != 0 & (Prd < 0.01 | Prd > 5)) {
    stop("Period out of range! \n\n")
  }
  retvals <- .Fortran("S04_LL08_E04", mag=as.single(Mag), rupdist=as.single(Rrup), specT=as.single(Prd),
