...
#'
#' \code{CB14.tw.C01} returns the ground-motion prediction with it sigma of Campbell and Bozorgnia(2014) GMPE
#' adjusted to Taiwan..
#'
...
#'
#' @examples
#' CB14.tw.C01(6, 20, 20, 0, 0, 760, 0, 1.5, 90, 10, 0, 20, 10, 0)
#' CB14.tw.C01(7, 20, 20, 0, 0, 760, 0, 1.5, 90, 10, 0, 20, 10, 0)
#'
#' @export
CB14.tw.C01 <- function(Mag, Rrup, Rjb, ftype=0, Prd, Vs30=760,
