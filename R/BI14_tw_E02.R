...
#'
#' \code{BI14.tw.E02} returns the ground-motion prediction with it sigma of Bindi et al.(2014) GMPE
#' adjusted to Taiwan.
#'
...
#'
#' @examples
#' BI14.tw.E02(6, 20, 0, 0, 760)
#' BI14.tw.E02(7, 10, 0, 0, 760)
#'
#' @export
BI14.tw.E02 <- function(Mag, Rjb, Prd=0, ftype=0, Vs30=760){
  #Bindi_Hor_2013 ( m, jbDist, ftype, specT,
  #                     period2, lnY, sigma, iflag, vs, phiT, tauT )
  if (Prd != 0 & (Prd < 0.01 | Prd > 3)) {
    stop("Period out of range! \n\n")
  }
  retvals <- .Fortran("S04_Bindi14_TW_E02", mag=as.single(Mag), jbDist=as.single(Rjb), ftype=as.single(ftype),
