...
#'
#' \code{ASK14.tw.C01} returns the ground-motion prediction with it sigma of Abrahamson et al.(2014) GMPE
#' adjusted to Taiwan.
#'
...
#'
#' @examples
#' ASK14.tw.C01(6, 20, 20, 0, 90, 0, 10, 760, 0, 0, 1, 0.5, 20, 10, 0, 0)
#' ASK14.tw.C01(7, 20, 20, 0, 90, 0, 10, 760, 0, 0, 1, 0.5, 20, 10, 0, 0)
#'
#' @export
ASK14.tw.C01 <- function(Mag, Rrup, Rjb, Prd, Dip, ftype=0, rupwidth, Vs30=760, hwflag=0,
  ...
  retvals <- .Fortran("ASK14_TW_C01", mag=as.single(Mag), dip=as.single(Dip), ftype=as.single(ftype),
