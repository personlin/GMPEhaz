...
#'
#' \code{BCHydroSub2018Global} returns the ground-motion prediction with it sigma of Abrahamson et al.(2016) GMPE.
#'
...
BCHydroSub2018Global <- function(Mag, Rrup, Prd, ftype=0, Vs30, forearc=1, depth, Rhypo) {
  ...
  #S05_BCHydroSub_Global ( mag, fType, rRup, vs30, lnSa, sigma1,
  #           specT, period1, iflag, forearc, depth, disthypo, deltac1 )
  retvals <- .Fortran("S05_BCHydroSub_Global", mag=as.single(Mag), fType=as.single(ftype), rRup=as.single(Rrup),
