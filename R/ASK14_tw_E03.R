...
#'
#' \code{ASK14.tw.E03} returns the ground-motion prediction with it sigma of Abrahamson et al.(2014) GMPE
#' adjusted to Taiwan.
#'
...
#'
#' @examples
#' ASK14.tw.E03(6, 20, 20, 0, 90, 0, 10, 760, 0, 0, 1, 0.5, 20, 10, 0, 0)
#' ASK14.tw.E03(7, 20, 20, 0, 90, 0, 10, 760, 0, 0, 1, 0.5, 20, 10, 0, 0)
#'
#' @export
ASK14.tw.E03 <- function(Mag, Rrup, Rjb, Prd, Dip, ftype=0, rupwidth, Vs30=760, hwflag=0,
  ...
  retvals <- .Fortran("S04_ASK14_TW_E03", mag=as.single(Mag), dip=as.single(Dip), ftype=as.single(ftype),
