#' GMPE function for Chao et al.(2018)
#'
#' \code{Chao2018} returns the ground-motion prediction with it sigma of Chao et al.(2018) GMPE.
#'
#'Chao et al.(2018)
#'
...
Chao2018 <- function(Mag, Rrup, Prd=0, ftype=0, Vs30=760, Vs30_class=0, Ztor = 0, Z1.0=0.0058959, sourcetype=0,
  ...
  retvals <- .Fortran("S04_Chao2018", mag=as.single(Mag), dist=as.single(Rrup), ftype=as.single(ftype),
