...
#'
#' \code{CY14.tw.C01} returns the ground-motion prediction with it sigma of Chiou and Youngs(2014) GMPE
#' adjusted to Taiwan.
#'
...
#'
#' @examples
#' CY14.tw.C01(6, 20, 20, 0, 760, 90, 0, 0, 0.5, 1, 0, 20, 0)
#' CY14.tw.C01(7, 20, 20, 0, 760, 90, 0, 0, 0.5, 1, 0, 20, 0)
#'
#' @export
CY14.tw.C01 <- function(Mag, Rrup, Rjb, Prd, Vs30, Dip, Ztor, ftype=0, Z1.0, Vs30_class=1, hwflag=0, Rx,
                    regionflag=0){
  ...
  retvals <- .Fortran("CY14_TW_C01", mag=as.single(Mag), Rrup=as.single(Rrup), Rbjf=as.single(Rjb),
