...
#'
#' \code{ASB14.tw.C01} returns the ground-motion prediction with it sigma of Akkar et al.(2014) GMPE
#' adjusted to Taiwan.
#'
...
#'
#' @examples
#' ASB14.tw.C01(6, 20, 0, 0, 760)
#' ASB14.tw.C01(7, 10, 0, 0, 760)
#'
#' @export
ASB14.tw.C01 <- function(Mag, Rjb, Prd=0, ftype=0, Vs30=760){
  #ASB_2013 ( mag, Rbjf, specT,
  #                     period2, lnY, sigma, iflag, ftype, Vs, phiT, tauT )
  if (Prd != 0 & (Prd < 0.01 | Prd > 4)) {
    stop("Period out of range! \n\n")
  }
  retvals <- .Fortran("S04_ASB14_TW_C01", mag=as.single(Mag), Rbjf=as.single(Rjb), specT=as.single(Prd),
