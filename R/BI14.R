...
#'
#' \code{BI14} returns the ground-motion prediction with it sigma of Bindi et al.(2014) GMPE.
#'
...
#'
#' @export
BI14 <- function(Mag, Rjb, Prd=0, ftype=0, Vs30=760){
  #Bindi_Hor_2013 ( m, jbDist, ftype, specT,
  #                     period2, lnY, sigma, iflag, vs, phiT, tauT )
  if (Prd != 0 & Prd != -1 & (Prd < 0.01 | Prd > 3)) {
